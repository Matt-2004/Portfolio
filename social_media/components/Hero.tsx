...
export const About = () => {
  ...
  return (
    <section id="home" className="w-full flex justify-center">
      <div className="md:w-[80%] w-[98%] sm:w-[90%] md:px-10 md:py-10 py-4 px-3 sm:px-8 rounded-xl gap-5 flex flex-col justify-center items-center bg-gradient-to-t from-[#2163a4] to-[#0a2e4f]">
        <Title text="ABOUT" />
        <div className="max-w-[29rem] min-w-full leading-6 text-start text-gray-200 ">
